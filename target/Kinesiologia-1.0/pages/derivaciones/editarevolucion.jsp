                ...
                <div class="col-md-9">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">                                    
                                   <div class="col-3">
                                        <div class="from-group">
                                            ...
                                            <input id="fecha_evaluacion" class="form-control" type="date" name="fecha_evaluacion" value="${evolucion.getFechaEvaluacion()}" readonly>
                                        </div>
                                    </div>
                                    <div class="col-1"></div>
                                    <div class="col-2">
                                        <div class="from-group">
                                            ...
                                            <input id="turno" class="form-control text-right" type="number" name="turno" value="${evolucion.getTurno()}">
                                        </div>
                                    </div>
                                    <div class="col-1"></div>
                                    <div class="col-2">
                                        <div class="from-group">
                                            ...
                                            <input id="nro_sesion" class="form-control text-right" type="number" name="nro_sesion" value="${evolucion.getNroSesion()}">
                                        </div>
                                    </div>
                                    <div class="col-1"></div>
                                    <div class="col-2">
                                        ...
                                        <input id="monto_evaluacion" class="form-control text-right" type="number" name="monto_evaluacion" value="${evolucion.getMontoEvaluacion()}">
                                    </div>
                                </div>
                            </div>
                            <p></p>
                            <div class="row">
                                <div class="col-4">
                                    <div class="from-group">
                                        ...
                                        <textarea id="kinesioterapia" class="form-control" name="kinesioterapia">${evolucion.kinesioterapia}</textarea>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <label for="fisioterapia" class="bmd-label-floating">Fisioterapia</label>
                                        <textarea id="fisioterapia" class="form-control" name="fisioterapia">${evolucion.fisioterapia}</textarea>
                                </div>
                                <div class="col-4">
                                    <label for="kinefilaxia" class="bmd-label-floating">Kinefilaxia</label> 
                                    <textarea id="kinefilaxia" class="form-control" name="kinefilaxia">${evolucion.kinefilaxia}</textarea>
                                </div>
                           </div>
                            ...
                            <input type="hidden" name="idEvolucion" id="idDerivacion" value="${evolucion.getIdEvolucion()}">
                        </div>
                    </div>
                </div>
            </div>
